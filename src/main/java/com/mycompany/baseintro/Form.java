...
public class Form extends javax.swing.JFrame {
					...
					private void cargarDatos() {
										...
										try {
															...
															while (consulta.next()) {
																				...
																				fila[2] = consulta.getString("documentNumber");
					...
					private boolean validarFechaNacimiento(java.util.Date fechaNacimiento) {
										return true;
					}

					public void actualizarTablaYLimpiar() {
										modelo.setRowCount(0);
										cargarDatos();
					...
					public void guardarPersona() {
										...
										java.util.Date fechaNacimiento =  dtBirthDate.getDate();
										if (!validarFechaNacimiento(fechaNacimiento)) {
															JOptionPane.showMessageDialog(null, "fecha");
															return;
										}
										try (Connection conexion = conectar.conectar()) {
															String sql = "INSERT INTO persona(documentType, documentNumber,name,"
															...
															JOptionPane.showMessageDialog(this, "Error al guardar" +e, "ERROR", JOptionPane.INFORMATION_MESSAGE);
										}
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                         .addGroup(jPanel3Layout.createSequentialGroup()
                              .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                   ...
                                   .addComponent(cbxDocumentType, 0, 145, Short.MAX_VALUE)
